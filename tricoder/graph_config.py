...
CALL_GRAPH_MAX_NODES_SMALL = 100  # For codebases < 1000 nodes
CALL_GRAPH_MAX_NODES_MEDIUM = 200  # For codebases < 5000 nodes (min 50, or 5% of nodes)
CALL_GRAPH_MAX_NODES_LARGE = 5000  # For codebases >= 5000 nodes (min 100, or 10% of nodes)
...
CALL_GRAPH_EDGE_SEARCH_LIMIT = 200  # Only check last N edges for duplicates (most are recent)

# ============================================================================
# Context Window Edge Limits
# ============================================================================

CONTEXT_WINDOW_MAX_NODES_PER_FILE = 500  # Max nodes to process per file (prevents O(n²) explosion)
CONTEXT_WINDOW_MAX_PAIRS_PER_FILE = 5000  # Max pairs to generate per file
